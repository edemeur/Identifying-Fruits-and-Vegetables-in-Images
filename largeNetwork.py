...
# To train the large network
# May require alterations to the paths for folders

dataset = "ch" #choose between original circle half quater ch ochq forest
...
info_file = open("Info_File_Large_{}.txt".format(dataset.lower()), "w")
...
torch.save(NN, "Save_File_Large_{}.pt".format(dataset.lower()))