...
# To test the large network
# May require alterations to the paths for folders

dataset = "ochq" #choose between original circle half quater ch ochq forest
model_dataset = "ochq"
...
NN = torch.load("Save_File_Large_{}.pt".format(model_dataset.lower()))
NN.eval()
...
test_file = open("Test_File_Large_{}_{}.txt".format(model_dataset, dataset), "w")
