...
for i in range(3):
    if i == 0:
        temp_dir = "archive/combined_half/Train/"
    elif i == 1:
        temp_dir = "archive/combined_half/Valid/"
    else:
        temp_dir = "archive/combined_half/Test/"
    for name in names:
        dir = temp_dir + name
        os.mkdir(dir)
